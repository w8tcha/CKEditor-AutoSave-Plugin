    ...
    var onTimer = function(event) {
        if (savingActive) {
            ...
            var editor = event.editor,
                autoSaveKey = (editor.config.autosave_SaveKey != null || typeof editor.config.autosave_SaveKey === "undefined") ? editor.config.autosave_SaveKey : 'autosave_' + window.location + "_" + editor.id;
